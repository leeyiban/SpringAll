 ...
 * 拦截器
 */
@Component("A20220630_Interceptor_Demo2")
public class A20220630_Interceptor_Demo2 implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		System.out.println("进入拦截器A20220630_Interceptor_Demo2方法中");
